...
final class MovieDetailView: UIView {
    ...
    private lazy var posterImageView: UIImageView = {
        let posterImageView = UIImageView.create()
        // TODO: blur ekle!
    ...
    let foregroundPosterImageView: UIImageView = {
        let foregroundPoster = UIImageView.create()
    ...
    private lazy var releaseDateLabel: UILabel = .create(text: "releaseDateLabel", font: .systemFont(ofSize: 12.0), textColor: .darkGray)
    
    private lazy var ratingLabel: UILabel = .create(text: "ratingLabel", font: .systemFont(ofSize: 12.0), textColor: .darkGray)
    
    private lazy var midView: UIView = {
        let view = UIView()
        let midStackView: UIStackView = .create(arrangedSubViews: [movieTitleLabel, releaseDateLabel, ratingLabel], axis: .horizontal, alignment: .center, distribution: .fillProportionally, spacing: 4.0)
...
extension MovieDetailView {
    ...
    func populateUI(posterImageViewURL: URL?, foregroundPosterImageViewURL: URL?, movieTitle: String, releaseDate: String, rating: Double, movieDescription: String){
